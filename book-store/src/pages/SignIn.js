      ...
      <div className={styles.panel}>
        <div className={styles.elements}>
          ...
          <form action="/api/users" method="GET">
            ...
            <button className={styles.whitebtn}><p className={styles.buttontxt}><Link href="/Home">Login</Link></p></button>
            <br />
            <button className={styles.orangebtn}><p className={styles.buttontxt}> <Link href="/SignUp">Register</Link></p></button>
          </form>
        </div>
      </div>
    </div>
